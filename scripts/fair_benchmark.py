...
class MinimalSpacyAnnotator:
    ...
    def __init__(self):
        ...
        self.pii_labels = [
            "PERSON", "ORG", "GPE", "CARDINAL", "DATE", "TIME", 
            "MONEY", "PERCENT", "FAC", "LOC"
        ]
...
def benchmark_engine(annotator, text: str, engine_name: str, num_runs: int = 5) -> Tuple[float, Dict]:
