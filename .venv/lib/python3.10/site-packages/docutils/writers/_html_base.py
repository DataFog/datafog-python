...
class HTMLTranslator(nodes.NodeVisitor):
        ...
        if "scale" in node:
            ...
            for i in range(2):
                if size[i]:
                    ...
                    size[i] = "%s%s" % (factor * float(match.group(1)), match.group(2))
        size_declarations = []
    ...
    def prepare_svg(self, node, imagedata, size_declaration):
        ...
        if size_declaration:  # append to style, replacing width & height
            ...
            declarations = [
                ...
                if d and not d.startswith("width") and not d.startswith("height")
            ]
    ...
    def uri2imagepath(self, uri):
        ...
        if imagepath.startswith("/"):
            ...
            imagepath = utils.relative_path(None, os.path.join(destdir, imagepath))
        return imagepath
        ...
        if loading == "lazy":
            ...
            try:
                ...
                if mimetype == "image/svg+xml":
                    element = self.prepare_svg(node, imagedata, size_declaration)
                else:
