...
from srsly.cloudpickle import (
    list_registry_pickle_by_value,
    register_pickle_by_value,
    unregister_pickle_by_value,
)
from srsly.cloudpickle.cloudpickle import (
    _extract_class_dict,
    ...
    def test_pickle_constructs_from_module_registered_for_pickling_by_value(self):  # noqa
        ...
        try:
            ...
            with subprocess_worker(protocol=self.protocol) as w:
                ...
                # modules.
                from mock_local_folder.mod import LocalClass, LocalT, local_function
