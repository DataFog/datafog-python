...
from .compat import (  # NOQA; type: ignore
    PY2,
    PY3,
    Hashable,
    MutableSequence,
...
# fmt: off
from .error import MantissaNoDotYAML1_1Warning, MarkedYAMLError, MarkedYAMLFutureWarning
...
from .scalarint import BinaryInt, HexCapsInt, HexInt, OctalInt, ScalarInt
