...
from langcodes.tag_parser import LanguageTagError, normalize_characters, parse_tag
...
class Language:
    ...
    def _display_pattern(self) -> str:
        ...
        if (
            self.distance(Language.get("zh")) <= 25
            or self.distance(Language.get("zh-Hant")) <= 25
        ):
